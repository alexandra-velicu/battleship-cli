...
describe('Player class', () => {
    ...
    it('should validate instruction with invalid ship', () => {
        const validation = player.validateInstruction('invalidShip', 'A1', 'right');
        expect(validation.message).toContain('Please enter a valid ship');
    });

    it('should validate instruction with valid inputs', () => {
        const validation = player.validateInstruction('cruiser', 'A1', 'right');
